...
| **gitleaks secret scan** — detect committed secrets | `gitleaks.yml` | `pull_request`, `push`, `schedule`, `workflow_dispatch` | available (v0.7.x) |
...
- [gitleaks secret scan](docs/quickstart-gitleaks.md) — committed-secret detection
